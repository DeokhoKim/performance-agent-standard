...
Req: Local Environment Primacy: Enforce local project toolchains over system-level defaults to guarantee reproducible build, test, and execution tasks.
- Rule: Precedence Hierarchy: Build, test, run, and artifact validation MUST strictly follow: `Local Environment > System Environment > General Assumption`.
